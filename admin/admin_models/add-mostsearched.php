...
if (UPLOAD_ERR_OK === $_FILES["image"]["error"]){
  ...
  if(in_array($file_extension, $extension)){
    $upload_image='../resources/images/most_searched_cars/'.$imagefilename;
    move_uploaded_file($imagefiletemp, $upload_image);
    $sql="insert into tb_most_searched_cars (carName, price, category, image) values ('$name','$price','$category','$upload_image')";
